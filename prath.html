...
<div class="container mt-4">
  ...
  <div class="hero text-center">
    <h1 class="fw-bold">🏠 Skyline Properties</h1>
    <p class="mb-0">Find Your Dream Home in Prime Locations</p>
  </div>

  <!-- Improvement 2: datalist with more cities -->
  <!-- Improvement 3: search button added -->
  <div class="text-center mb-4">
    <input list="cities" id="searchInput" class="form-control w-50 mx-auto" placeholder="Search by city...">
    <datalist id="cities">
      <option value="Pune">
      <option value="Mumbai">
      <option value="Nashik">
    ...
    <button class="btn btn-primary search-btn" onclick="filterCards()">🔍 Search</button>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-3">
      <div class="sidebar">
        ...
        <button class="btn btn-success w-100 fw-bold mb-2" onclick="filterCards()">Apply Filters</button>
    ...
    <div class="col-md-9">
      <div class="row g-3" id="card-container">
        ...
        <div class="col-md-4">
          <div class="card">
            <figure class="mb-0">
              <img src="https://images.pexels.com/photos/106399/pexels-photo-106399.jpeg?w=400" class="card-img-top" alt="Green Valley">
        ...
        <div class="col-md-4">
          <div class="card">
            <figure class="mb-0">
              <img src="https://images.pexels.com/photos/323772/pexels-photo-323772.jpeg?w=400" class="card-img-top" alt="Skyline Heights">
            ...
            <div class="card-body">
              ...
              <details>
                <summary>View Details</summary>
                <p>📍 Mumbai &nbsp; 🛏️ 3 BHK &nbsp; 📐 1400 sqft<br>📞 9123456780<br>
        ...
        <div class="col-md-4">
          <div class="card">
            <figure class="mb-0">
              <img src="https://images.pexels.com/photos/261102/pexels-photo-261102.jpeg?w=400" class="card-img-top" alt="Blue Star">
